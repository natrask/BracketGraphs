...
sys.path.insert(0, os.path.abspath(os.getcwd()) + '/src-new')
...
def main(opt):
    ...
    return train_acc, val_acc, test_acc, best_epoch
...
if __name__ == '__main__':
    ...
    parser.add_argument('--2clique_features', default=False, action='store_true', 
                        help='if data has 2-clique features')
    # Attention args
